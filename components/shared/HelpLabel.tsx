      ...
      {helpText ? (
        <span ref={wrapperRef} className="relative inline-flex">
          ...
          {open ? (
            <span
              role="tooltip"
              className="pointer-events-none absolute left-0 top-full z-20 mt-1 w-64 rounded-md border border-slate-200 bg-white p-2 text-xs font-normal normal-case tracking-normal text-slate-700 shadow-lg dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200"
            >
              {helpText}
            </span>
          ) : null}
